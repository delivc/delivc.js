...
module.exports = function (api) {
    ...
    if (env === 'browser') {
        babelConfig = Object.assign({}, babelConfig, {
            presets: ["@babel/typescript", ['@babel/preset-env', browserBabelPresetEnvConfig]]
        })
    }
    if (env === 'legacy') {
        babelConfig = Object.assign({}, babelConfig, {
            presets: ["@babel/typescript", ['@babel/preset-env', legacyBabelPresetEnvConfig]]
        })
    }
    ...
    if (env === 'modules') {
        babelConfig = Object.assign({}, babelConfig, {
            presets: ["@babel/typescript", ['@babel/preset-env', modulesBabelPresetEnvConfig]]
        })
    }

    if (env === 'node') {
        babelConfig = Object.assign({}, babelConfig, {
            presets: ["@babel/typescript", ['@babel/preset-env', nodeBabelPresetEnvConfig]]
        })
    }

    if (env === 'test') {
        babelConfig = Object.assign({}, babelConfig, {
            presets: ["@babel/typescript", ['@babel/preset-env', testBabelPresetEnvConfig]],
